...
TEST_CASE("Test try to move empty space"){
    ...
    CHECK_THROWS( b.move(2, {2,3}, Board::MoveDIR::Up) );
    CHECK_THROWS( b.move(1, {1,2}, Board::MoveDIR::Down) );
}
...
TEST_CASE("Test moving on board with no enemies"){
    ...
    b.move(1, {0,1}, Board::MoveDIR::Down);
    b.move(1, {3,3}, Board::MoveDIR::Down);
    b.move(1, {2,0}, Board::MoveDIR::Right);
    b.move(1, {2,1}, Board::MoveDIR::Down);
...
// copy paste to have 100 tests for badkan
